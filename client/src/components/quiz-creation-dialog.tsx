...
export default function QuizCreationDialog({
  grades,
  groups,
  ...
  const handleSubmit = () => {
    ...
    if (!formData.deadline) {
      toast({
        title: "يرجى تحديد موعد انتهاء الاختبار",
        variant: "destructive",
      });
      return;
    }
    ...
    if (formData.questions.length === 0) {
      toast({
        title: "يرجى إضافة سؤال واحد على الأقل",
        variant: "destructive",
      });
      return;
    }
    ...
    createQuizMutation.mutate(formattedData);
  };
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-slate-800 border-slate-700">
        ...
        <div className="space-y-6 py-4">
          ...
          <Card className="bg-slate-700/50 border-slate-600">
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="quiz-subject" className="text-slate-300">
                    المادة الدراسية
                  </Label>
                  <Input
                    id="quiz-subject"
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="quiz-grade" className="text-slate-300">
                    المرحلة الدراسية
                  </Label>
                  <Select
                ...
                <div className="space-y-2">
                  <Label htmlFor="quiz-group" className="text-slate-300">
                    المجموعة
                  </Label>
                  <Select
                ...
                <div className="space-y-2">
                  <Label htmlFor="quiz-duration" className="text-slate-300">
                    المدة (دقيقة)
                  </Label>
                  <Input
                    id="quiz-duration"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="quiz-max-attempts" className="text-slate-300">
                ...
                <div className="space-y-2">
                  <Label htmlFor="quiz-deadline" className="text-slate-300">
          ...
          <Card className="bg-slate-700/50 border-slate-600">
            <CardHeader>
              <CardTitle className="text-white">
                إدارة الأسئلة ({formData.questions.length})
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-4 p-4 bg-slate-600/50 rounded-lg">
                <div className="space-y-2">
                  <Label htmlFor="question-text" className="text-slate-300">
                    نص السؤال
                  </Label>
                  <Textarea
                    id="question-text"
                ...
                <div className="space-y-2">
                  <Label htmlFor="question-type" className="text-slate-300">
                    نوع السؤال
                  </Label>
                  <Select
                      ...
                      setCurrentQuestion((prev) => ({
                        ...
                        options:
                          value === "true-false"
                            ...
                            : ["", "", "", ""],
                        correctAnswer:
                          value === "true-false" ? "" : prev.correctAnswer,
                      }));
                    }}
                  >
                    <SelectTrigger className="bg-slate-700 border-slate-600 text-white">
                      ...
                      <div key={index} className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setCurrentQuestion((prev) => ({
                              ...prev,
                              correctAnswer: newOptions[index],
                            }));
                          }}
                          className={
                ...
                {currentQuestion.type === "true-false" && (
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-4">
                      <Button
                        variant={
                          currentQuestion.correctAnswer === "صح"
                            ? "default"
                            : "outline"
                        }
                        onClick={() =>
                      ...
                      <Button
                        variant={
                          currentQuestion.correctAnswer === "خطأ"
                            ? "default"
                            : "outline"
                        }
                        onClick={() =>
        ...
        <div className="flex gap-2">
          <Button
            ...
            disabled={
              createQuizMutation.isPending || formData.questions.length === 0
            }
            className="bg-blue-600 hover:bg-blue-700"
